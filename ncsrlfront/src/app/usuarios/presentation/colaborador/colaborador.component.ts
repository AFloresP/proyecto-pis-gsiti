...
export class ColaboradorComponent implements OnInit {
    ...
    restablecer() {
        if(this.selectedColaborador) {
            this.confirmationService.confirm({
                message: '¿Quieres restablecer la cuenta de este usuario?',
                header: 'Confirmacion',
                icon: 'pi pi-info-circle',
                accept: () => {
                    ...
                    this.showbar = true;
                    this.colaboradorService.restoreColaborador(this.selectedColaborador.id_col).subscribe(
                        (_resp: any) => {
                            this.showMessage('success', 'Exito', 'Cuenta Restablecida');
                            this.showbar = false;
                        },
                        (error) => {
                            console.log(error);
